...
const PROFILE_FIELDS = `
  ...
  height, weight, blood_group, ethnicity, marital_status, has_kids, id_verified,
...
export default async function DiscoverPage() {
  ...
  const profiles: ProfileData[] = safeRows.map((p) => ({
    ...
    blood_group: (p as Record<string, unknown>).blood_group as string ?? null,
  ...
  const myProfile: ProfileData | null = myRow ? {
    ...
    blood_group: (myRow as Record<string, unknown>).blood_group as string ?? null,
